...
- Some variables are suggested by the literature (e.g. *winset*) and are composed of other variables, but **aren't regularly updated**.
...
- **Development** with [rOpenGov](http://ropengov.github.io/).
